function [M,C,K,fnl,dfnl,fext, outdof] = build_model_functional(nDiscretization)
...
disp(['Total time spent on model assembly = ' datestr(datenum(0,0,0,0,0, computationTimeLIN),'HH:MM:SS')])
