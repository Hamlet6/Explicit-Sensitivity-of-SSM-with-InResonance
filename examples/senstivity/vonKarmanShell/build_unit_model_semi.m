function [M,K,fnl,dfnl,fext,outdof] = build_unit_model_semi(nDiscretization)
...
filename = ['tensors_' num2str(MyMesh.nElements) '_semi.mat'];
try     
    load(filename,'M','K','fnl','dfnl','outdof','fext');
    ...
    save(filename,'M','K','fnl','dfnl','fext','outdof');
end
end