...
%% generate model
alpha = 3; % alpha = 0.5, f0 = 10; alpha = 5.85 f0 = 8500;
beta  = 1e-3;
f0 = 1000; % 600 11000
...
[tout,xout] = time_integration_transient(DS,omegas(idx),'outdof',outdof,...
    'integrationMethod','Newmark','nCycles',10,'nSteps',128,'init',tmp(:,idx));
figure;
plot(tout,xout)
%%
idx_set = [72 74];
