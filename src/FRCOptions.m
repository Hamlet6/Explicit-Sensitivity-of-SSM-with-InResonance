classdef FRCOptions < matlab.mixin.SetGet
    ...
    properties        
        ...
        interpMethod = 'quadratic' % interpolation method for approximating the leading-order non-autonomous part of SSM
    end
    ...
    methods      
        ...
        function set.interpMethod(obj,interpMethod)
            switch lower(interpMethod)
                case 'constant'
                    obj.interpMethod = 'constant';
                case 'linear'
                    obj.interpMethod = 'linear';
                case 'quadratic'
                    obj.interpMethod = 'quadratic';
                otherwise
                    error('Unknown interpMethod type: set constant/linear/quadratic types')
            end
        end
