classdef Manifold < matlab.mixin.SetGetExactNames
    ...
    methods
        ...
        [W_0j, R_0j, H] = cohomological_solution(obj, i,  W_0, R_0, H,multi_input)
        ...
        [W,R] = explicit_whisker(obj)
        
        [DW,DR] = explicit_senstivity_whisker(obj,W,R)

        dr21 = adjoint_sentivity(obj, W20, W11, W30, W21, r21);
        dr21 = adjoint_dr21(obj, W20, W11, W30, W21, r21);
    end
