classdef SSM < Manifold
    ...
    methods
        ...
        varargout = po_sensitivity(obj,W,R,DW,DR,optdof,Q,epsilon);
        varargout = BB_sensitivity(obj,W,R,DW,DR,outdof,freqRange,pidx,pfracs)
        varargout = FRC_sensitivity(obj,W,R,DW,DR,optdof,Q,epsilon,freqRange,pidx,pfracs,varargin);
        varargout = SSM_sensitivity(obj,W,DW,rhosamp,plotdof,pidx,pfracs);
        varargout = LC_sensitivity(obj,W,R,DW,DR,outdof,pidx,pfracs);
    end
